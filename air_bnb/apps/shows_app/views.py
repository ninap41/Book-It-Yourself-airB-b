...
def venue_profile(request, venue_id):
        ...
        musicians = []
        for show in shows:
                if Musicians.objects.filter(show_id=show):
                        band = Musicians.objects.filter(show_id=show)
...
def band_submission(request, venue_id, show_id):
        ...
        try:  
                ...
                Musicians.objects.create(show_id=current_show, musician_id=musician_id, artist_name=artist_name, other_profiles=other_profiles, email=email, bio=bio)
